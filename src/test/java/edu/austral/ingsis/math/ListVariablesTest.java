...
public class ListVariablesTest {
  ...
  public void shouldListVariablesFunction2() {
    ...
    final VariableFunction function =
        new VariableFunction(
            new Division(new Constant(new MathNumber(12)), new Variable("div")));
    final Printer printer = new Printer();
    printer.visit(function);
    assertEquals(result, printer.getLastVisitedValue());
    //Variable list test
  ...
  public void shouldListVariablesFunction3() {
    ...
    final VariableFunction function = new VariableFunction(new Product(innerDivision, new Variable("y")));
    final Printer printer = new Printer();
    printer.visit(function);
    assertEquals(result, printer.getLastVisitedValue());
    //Variable list test
  ...
  public void shouldListVariablesFunction4() {
    ...
    final Division innerDivision = new Division(new Constant(new MathNumber(27)), new Variable("a"));
    final VariableFunction function = new VariableFunction(new Power(innerDivision, new Variable("b")));
    final Printer printer = new Printer();
    printer.visit(function);
    assertEquals(result, printer.getLastVisitedValue());
    //Variable list test
